...
\begin{frame}{Making groups}
  All homework will be done in groups
  \begin{block}{Groups}
    \begin{itemize}
\pause
      \item form groups of 3-5 people
\pause
      \item sign up on Canvas!
\pause
      \item only one person per group submits the assignment
    \end{itemize}
  \end{block}
\end{frame}
