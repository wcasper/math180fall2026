...
\begin{frame}{How to Play}
  \begin{block}{Rules}
    \begin{itemize}
\pause
      \item players take turns dropping disks into $7\times 6$ board
\pause
      \item first player to get $4$-in-a-row wins
    \end{itemize}
  \end{block}
  \begin{block}{Fun Facts}
    \begin{itemize}
\pause
      \item game was originally released by 1974
\pause
      \item game was ``solved" in 1988 by Victor Allis
    \end{itemize}
  \end{block}
\end{frame}
    
\begin{frame}{Let's Play}
  \begin{block}{Activity (40 mins)}
